# Borrowed from https://github.com/noureldien/timeception
########################################################################
...
class ModelSaver():
    def __init__(self, model, dataset_name, model_name):
        ...
        model_root_path = '/home/mahdiar/Projects/pytorch-i3d/models'
        assert os.path.exists(model_root_path)

        model_root_path = '/home/mahdiar/Projects/pytorch-i3d/models/%s,%s' % (dataset_name, model_name)
