...
from I3D.charades_dataset import Charades as Dataset


def run(init_lr=0.1, max_steps=64e3, root='/home/mahdiar/Projects/pytorch-i3d/charades/Fake',
        train_split='/home/mahdiar/Projects/pytorch-i3d/charades/charades_Fake.json', batch_size=8*5, save_model=''):
    # setup dataset
    ...
    if mode == 'flow':
        ...
        i3d.load_state_dict(torch.load(pretrained_charades_root))
    else:
    ...
    while steps < max_steps:#for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for data in dataloaders[phase]:
                ...
                #print(map_charades(preds, torch.max(labels, dim=2)[0]))
